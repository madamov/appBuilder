//%attributes = {}
// sets the location to 4D CLient
...
If (OK=1)
	...
	If (Is macOS:C1572)
		$elementPath:="/Preferences4D/BuildApp/SourcesFiles/CS/ClientMacFolderToMac"
	Else 
		If (Is Windows:C1573)
			$elementPath:="/Preferences4D/BuildApp/SourcesFiles/CS/ClientWinFolderToWin"
		End if 
	End if 
