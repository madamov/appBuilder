//%attributes = {}
// sets ServerEmbedsProjectDirectoryFile to true in build XML settings file
...
If (OK=1)
	...
	$elementPath:="/Preferences4D/BuildApp/CS/LastDataPathLookup/"
	...
	DOM SET XML ELEMENT VALUE:C868($element_found; "ByAppName")
